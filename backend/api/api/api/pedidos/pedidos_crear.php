...
$comensales     = intval($body['comensales'] ?? 1);
...
$stmt = $db->prepare("INSERT INTO Pedidos (restaurante_id, mesa_id, trabajador_id, reserva_id, comensales) VALUES (?, ?, ?, ?, ?)");
$stmt->execute([$restaurante_id, $mesa_id, $trabajador_id, $reserva_id, $comensales]);
